...
import HeroSectionEdit from './sections/HeroSection';
import FeaturesSectionEdit from './sections/FeaturesSection';
import StorySectionEdit from './sections/StorySection';
import FosterSectionEdit from './sections/FosterSection';
import BreedSectionEdit from './sections/BreedSection';
import SuccessSectionEdit from './sections/SuccessSection';
import TestimonialSectionEdit from './sections/TestimonialSection';
  ...
  const handleUploadImage = async (file: File, index?: number) => {
    try {
      ...
      setHomeSection((prevSection) => {
        ...
        } else if (prevSection.sectionType === 'successStory' && typeof index === 'number') {
        ...
        } else if (prevSection.sectionType === 'testimonial' && typeof index === 'number') {
