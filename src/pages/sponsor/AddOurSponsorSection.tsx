...
import SponsorSectionForm from "../sections/aboutUsForms/Sponsors/SponsorSectionForm";
import FosterSectionForm from "../sections/aboutUsForms/Sponsors/FosterSectionForm";
import VolunteerSectionForm from "../sections/aboutUsForms/Sponsors/VolunteerSectionForm";
import BecomeASponsorSectionForm from "../sections/aboutUsForms/Sponsors/BecomeASponsorSectionForm"; 
...
import BecomeASponsorPreview from "../previews/AboutUs/Sponsors/BecomeASponsorPreview"; 
...
const AddOurSponsorSection: React.FC = () => {
  ...
  const renderPreview = () => {
    ...
    switch (section.sectionType) {
      ...
      case "volunteers":
        return (
          <VolunteerSectionPreview volunteers={section.volunteers || []} />
        );
      case "becomeASponsor":
        return section.becomeASponsor && section.becomeASponsor.length > 0 ? (
      ...
      <main className="add-our-sponsor-container">
        ...
        {section?.sectionType === "becomeASponsor" && (
          <BecomeASponsorSectionForm
            ...
            onUpdate={(data) =>
              setSection({ ...section, becomeASponsor: data })
            }
            onImageFileChange={(file, index) =>
              handleImageFileChange(file, index)
            }
          />
        )}
