...
interface BreedSectionEditProps {
  sectionData: BreedSection;
  onUpdate: (section: BreedSection) => void;
  onUploadImage: (file: File) => void;
}

const BreedSectionEdit: React.FC<BreedSectionEditProps> = ({
  sectionData,
  onUpdate,
  onUploadImage,
}) => {
...
export default BreedSectionEdit;
